...
import com.schematix.cryptoupiapp.upiapplibrary.constants.Constants.BASE_PROGRESS_BUTTON_CORNER_RADIUS
...
fun LoadingButton(
    ...
    cornerRadius: Int = BASE_PROGRESS_BUTTON_CORNER_RADIUS,
